...
public class Mensagens_Prontas {
    ...
    public void erroParaCombobox (String nome, String descricao, JComboBox campo){
        JOptionPane.showMessageDialog(null, "O valor inserido em "+nome+" é inválido \n"+descricao, "ALERTA IMPORTANTE", JOptionPane.ERROR_MESSAGE);
        campo.requestFocus();
    }
    ...
    public boolean confirmarAcao (String acao) {
        if (JOptionPane.showConfirmDialog(null, "Você tem certeza que deseja "+acao+"?", "MENSAGEM DE CONFIRMAÇÃO", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
            return true;
        }
        else
            return false;
