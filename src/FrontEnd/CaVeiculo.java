 ...
 * @author samuel
 */
public class CaVeiculo extends PaCadData{
    public CaVeiculo (String username){
        ...
        this.tuplas = "(Placa, CodModelo, CodCor, CodProprietario)";
        ...
        this.localOpenBtn = new String[] {"modelo", "cor", "proprietario"};
    }
}
